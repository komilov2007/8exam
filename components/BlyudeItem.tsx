...
const BlyudaItem = ({ image, text, name, price }: NewsCardProps) => {
  return (
    <div className="relative w-65.75 h-77.5 rounded-[38px] bg-white/30 backdrop-blur-md px-5 pb-5 pt-14 shadow-md">
      <div className="absolute w-65.75 h-49.25 -top-17 left-32 -translate-x-1/2">
        <div className="relative w-60.75  ml-3 h-60   overflow-hidden border-2 border-green-500">
